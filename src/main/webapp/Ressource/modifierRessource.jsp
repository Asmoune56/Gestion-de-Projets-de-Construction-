...
<style>
    * {
    ...
    header{
        ...
        align-items: center;
        height: 92vh;
        background-image:  url('https://png.pngtree.com/background/20230617/original/pngtree-scientific-background-with-3d-rendered-network-plexus-picture-image_3668302.jpg');
