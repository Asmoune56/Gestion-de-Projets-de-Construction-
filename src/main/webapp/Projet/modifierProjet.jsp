...
<head>
    ...
    <title>Modifier un Projet | ConstructionXpert</title>
    ...
    <style>
        ...
        * {
        ...
        header {
            ...
            url('https://img3.wallspic.com/previews/3/0/0/1/1/111003/111003-batiment-galet-brique-mur_de_pierre-materiaux_de_construction-500x.jpg') no-repeat center center/cover;
...
<header>
    <div class="container">
        <h2><i class="fas fa-edit"></i> Modifier un Projet</h2>
        <form action="projet?action=modifier" method="post">
            ...
            <div class="content">
                ...
                <div class="input-box">
                    ...
                    <input type="text" id="description" name="description" value="${projetParid.description}" required>
                </div>
