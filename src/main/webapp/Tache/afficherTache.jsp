...
<div class="container">
    <div class="page-header">
        <h1 class="page-title"><i class="fas fa-tasks"></i> Liste des Tâches</h1>
        <a href="tache?action=new" class="add-btn">
                ...
                <tr>
                    ...
                    <td>
                        <div class="action-btns">
                            <a href="tache?action=edit&id=${tache.id_TA}" class="action-btn edit-btn">
                                <i class="fas fa-edit"></i> Modifier
                            </a>
                            <a href="tache?action=supprimer&id=${tache.id_TA}" class="action-btn delete-btn">
                                <i class="fas fa-trash-alt"></i> Supprimer
                            </a>
                            <a href="tacheRessource?action=afficherAttachForm&id_tache=${tache.id_TA}" class="action-btn resource-btn">
                                <i class="fas fa-user-plus"></i> Ressource
                            </a>
                        </div>
                    </td>
                </tr>
