    ...
    <style>
        ...
        * {
        ...
        header {
            ...
            url('http://ie.edu/insights/wp-content/uploads/2020/11/VanSchendel-Construction.jpg') no-repeat center center/cover;
        ...
        <form action="tache?action=ajouter" method="post">
            <div class="content">
                ...
                <div class="input-box full-width">
                    ...
                    <input type="text" id="description" name="description" placeholder="Entrez la description de la tâche" required>
                </div>
